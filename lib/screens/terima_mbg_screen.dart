...
class RiwayatMBGScreen extends StatefulWidget {
  const RiwayatMBGScreen({super.key});

  @override
  State<RiwayatMBGScreen> createState() => _RiwayatMBGScreenState();
}

class _RiwayatMBGScreenState extends State<RiwayatMBGScreen> {
  double _rating = 0;
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: const Column(
                      ...
                      children: [
                        Icon(Icons.image, size: 45, color: Colors.blue),

                        SizedBox(height: 10),

                        Text("Upload foto sementara dinonaktifkan"),
                      ],
                    ),
                  ),
                ],
